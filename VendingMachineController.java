...
public class VendingMachineController extends Component {
    ...
    public VendingMachineController() {
        ...
        specialVendingMachine.initializeItemSlots();
    ...
    /**
     * Set the MaintenanceGUI instance for this VendingMachineController.
     * The MaintenanceGUI is used to display and handle maintenance-related actions.
     *
     * @param maintenanceGUI The MaintenanceGUI instance to be set.
     */
    public void setMaintenanceGUI(MaintenanceGUI maintenanceGUI) {
        this.maintenanceGUI = maintenanceGUI;
    }
